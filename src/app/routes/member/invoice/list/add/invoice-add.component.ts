...
export class InvoiceAddComponent extends DestroySubscription implements OnInit {
  constructor(
  ...
  typeChange(type: number): void {
    this.form.type = type;
    if (type != BillType.VAT_NORMAL_Bill && this.hasVat) {
      //专用发票
      ...
      this.form.billingAccountName = null;
      this.form.billingAccountPhone = null;
      this.form.billingAccountAddress = null;
      this.areaDetails = [];
    }
  }
