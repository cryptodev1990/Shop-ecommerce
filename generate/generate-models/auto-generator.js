...
class AutoGenerator {
    ...
    makeHeaderTemplate(tableName) {
        let header = `/**
 * File Name  : ${tableName}.ts
 * Authors    : ${this.options.updateUserName}
 * Created    : ${moment().format('YYYY/MM/DD HH:mm:ss').valueOf()}
 * Copyright  : Copyright © ${moment().year()} TongJun Info, Inc. All rights reserved.
 */\n`;
